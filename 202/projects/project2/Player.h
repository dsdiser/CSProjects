...
public:
  ...
  // Name - HasPair()
  // Desc - Function checks to see if player has a pair of cards.
  //        
  // Preconditions - None
  // Postconditions - True if the player has a pair of cards, false otherwise
  bool HasPair(int type);
  ...
  // Name - ReturnDefuse()
  // Desc - Returns the defuse card the player has in the event of a bomb drawn
  // Preconditions - A bomb in the player's hand
  // Postconditions - A card object that is the defuse the player has
  Card ReturnDefuse();
